...
class Migration(migrations.Migration):
    ...
    replaces = [('calendario', '0006_alter_positiondefinition_options_and_more')]


    dependencies = [
        ('personal', '0005_delete_operatorfarmpreference'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='positiondefinition',
            options={'ordering': ('display_order', 'id'), 'verbose_name': 'Definición de posición', 'verbose_name_plural': 'Definiciones de posiciones'},
        ),
        migrations.AlterModelOptions(
            name='shiftassignment',
            options={'ordering': ('date', 'position__display_order', 'position__code'), 'verbose_name': 'Asignación', 'verbose_name_plural': 'Asignaciones'},
        ),
        migrations.AddField(
