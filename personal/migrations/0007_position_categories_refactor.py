...
def migrate_position_categories(apps, schema_editor) -> None:
    ...
    OperatorCapability = apps.get_model("personal", "OperatorCapability")
...
class Migration(migrations.Migration):
    ...
    replaces = [('calendario', '0007_position_categories_refactor')]


    dependencies = [
        ("personal", "0006_alter_positiondefinition_options_and_more"),
    ]
