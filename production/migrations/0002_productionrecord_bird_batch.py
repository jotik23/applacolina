...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(*_rename_table_sql("granjas_chickenhouse", "production_chickenhouse")),
        ...
        migrations.RunSQL(*_rename_table_sql("granjas_productionrecord", "production_productionrecord")),
