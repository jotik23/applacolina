...
from .views import (
    ...
    egg_dispatch_create_view,
    egg_dispatch_delete_view,
    egg_dispatch_list_view,
    egg_dispatch_update_view,
...
urlpatterns = [
    ...
    path("despachos/", egg_dispatch_list_view, name="egg-dispatch-list"),
    path("despachos/nuevo/", egg_dispatch_create_view, name="egg-dispatch-create"),
    path("despachos/<int:pk>/editar/", egg_dispatch_update_view, name="egg-dispatch-update"),
    path("despachos/<int:pk>/eliminar/", egg_dispatch_delete_view, name="egg-dispatch-delete"),
